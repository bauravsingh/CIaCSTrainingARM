...
$subscriptionId = "726bfeae-0efe-48ac-9acd-d29e8a80da41" #insert your subscription ID
$resourceGroupName = "BauravCIaCS-rg"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/bauravsingh/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/bauravsingh/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
